...
int main(int argc, char *argv[])
{
  ...
  qmlRegisterType<MapQuickView>("Esri.QtAcademyProject", 1, 0, "MapView");

  // Register the QtAcademyProject (QQuickItem) for QML
  qmlRegisterType<QtAcademyProject>("Esri.QtAcademyProject", 1, 0, "QtAcademyProject");
